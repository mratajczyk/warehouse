...
loaded_import_data = {
    "inventory": [
        {"name": "leg", "article_id": "1", "stock": 12.0},
        {"name": "screw", "article_id": "2", "stock": 17.0},
        {"name": "seat", "article_id": "3", "stock": 2.0},
        {"name": "table top", "article_id": "4", "stock": 1.0},
    ],
    "products": [
        {
            "name": "Dining Chair",
            "contain_articles": [
                {"article_id": "1", "amount": 4.0},
                {"article_id": "2", "amount": 8.0},
                {"article_id": "3", "amount": 1.0},
            ],
        },
        {
            "name": "Dinning Table",
